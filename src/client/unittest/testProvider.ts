...
//     let unitTestCodeLens = new TestResultsCodeLensProvider(symbolProvider);
//     context.subscriptions.push(vscode.languages.registerCodeLensProvider(PYTHON, unitTestCodeLens));

//     testExplorer.activate(context, unitTestOutChannel, symbolProvider);
// }

export function runUnitTests(testProviders: baseTest.BaseTestRunner[], outputChannel: vscode.OutputChannel) {
    outputChannel.clear();
